...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
                ...
                <div class="top-nav">
                    ...
                    <ul class="nav-right pull-right list-unstyled">
                        ...
                        <li class="dropdown langs text-normal" data-ng-controller="LangCtrl">
                            ...
                            <ul ng-hide="true" class="dropdown-menu with-arrow  pull-right list-langs" role="menu">
        ...
        <script src="<?php echo base_url(); ?>scripts/developapp.js"></script>
        <script src="<?php echo base_url(); ?>lib/develop.js"></script>
    </body>
